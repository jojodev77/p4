...
public class FareCalculatorServiceTest {
	 ...
	 * 
	 * @author j.de-la-osa
	 * @description calcul price ticket when time in parking is less then one hour
	 *              with a bike
	 */
	@Test
	 ...
	 * 
	 * @author j.de-la-osa
	 * @description calcul price ticket when time in parking during 24 hours with a
	 *              car
	 */
	@Test
	 ...
	 * 
	 * @author j.de-la-osa
	 * @description calcul price ticket when time in parking is less than 30 minutes
	 *              with a car
	 */
	@Test
